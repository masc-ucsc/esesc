...
do
  ...
  $4/conf/report.pl --last > $3/regression/report/report.$1.$BENCHMARK
done
...
for BENCHMARK in crafty mcf vpr #swim mcf crafty 
do
  echo $1, Exetime, BrMis, DL1lat, IPC, uIPC, rawInst, >>$3/regression/tables/$1.$date.$BENCHMARK

  if [ "$BENCHMARK" = crafty ]; then 
    echo -n crafty ,  >>$3/regression/tables/$1.$date.crafty	
    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t Exe -o 1 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t MisBr -o 18 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t Cache -o 24 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t IPC -o 18 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t uIPC -o 18 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t rawInst -o 18 -c >>$3/regression/tables/$1.$date.crafty

    echo "" >>$3/regression/tables/$1.$date.crafty

  else if [ "$BENCHMARK" = vpr ]; then
    echo -n VPR , >>$3/regression/tables/$1.$date.vpr 
    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t Exe -o 1 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t MisBr -o 18 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t Cache -o 23 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t IPC -o 18 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t uIPC -o 18 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t rawInst -o 18 -c >>$3/regression/tables/$1.$date.vpr

    echo "" >>$3/regression/tables/$1.$date.vpr

  else if [ "$BENCHMARK" = mcf ]; then        
    echo -n MCF , >>$3/regression/tables/$1.$date.mcf 
    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t Exe -o 1 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t MisBr -o 18 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t Cache -o 23 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t IPC -o 18 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t uIPC -o 18 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f report.$1.$BENCHMARK -t rawInst -o 18 -c >>$3/regression/tables/$1.$date.mcf
