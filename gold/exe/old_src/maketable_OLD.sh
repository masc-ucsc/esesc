...
do
  ...
  if [ "$BENCHMARK" = crafty ]; then 
    ...
    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 Exe -o 1 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 MisBr -o 18 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 Cache -o 24 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 IPC -o 18 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 uIPC -o 18 -c >>$3/regression/tables/$1.$date.crafty

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 rawInst -o 18 -c >>$3/regression/tables/$1.$date.crafty

    echo "" >>$3/regression/tables/$1.$date.crafty

  else if [ "$BENCHMARK" = vpr ]; then
    echo -n VPR , >>$3/regression/tables/$1.$date.vpr 
    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 Exe -o 1 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 MisBr -o 18 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 Cache -o 23 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 IPC -o 18 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 uIPC -o 18 -c >>$3/regression/tables/$1.$date.vpr

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 rawInst -o 18 -c >>$3/regression/tables/$1.$date.vpr

    echo "" >>$3/regression/tables/$1.$date.vpr

  else if [ "$BENCHMARK" = mcf ]; then        
    echo -n MCF , >>$3/regression/tables/$1.$date.mcf 
    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 Exe -o 1 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 MisBr -o 18 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 Cache -o 23 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 IPC -o 18 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 uIPC -o 18 -c >>$3/regression/tables/$1.$date.mcf

    $4/gold/exe/tokens -f0 report.$1.$BENCHMARK -t0 rawInst -o 18 -c >>$3/regression/tables/$1.$date.mcf
