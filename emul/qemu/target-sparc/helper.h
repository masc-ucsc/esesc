...
DEF_HELPER_3(ld_leswap, i64, tl, int, int)
DEF_HELPER_3(st_leswap, void, tl, tl, int)
DEF_HELPER_3(ldf_leswap, void, tl, int, int)
DEF_HELPER_3(stf_leswap, void, tl, int, int)
#endif
