    ...
    if(is_unsigned) {
      ...
      if(!is_long) {
        for(int i = 0; i < 2; i++) {
          ...
          temp16 = ((int16_t)sixteen1 > (int16_t)sixteen2) ? ((int16_t)sixteen1 - (int16_t)sixteen2)
                                                           : ((int16_t)sixteen1 - (int16_t)sixteen1);
          temp16 += acc16;
          temp |= (uint32_t)temp16 << (16 * i);
        }
        ...
        for(int i = 0; i < 2; i++) {
          ...
          temp16 = ((int16_t)sixteen1 > (int16_t)sixteen2) ? ((int16_t)sixteen1 - (int16_t)sixteen2)
                                                           : ((int16_t)sixteen2 - (int16_t)sixteen1);
          temp16 += acc16;
          temp |= (uint32_t)temp16 << (16 * i);
        }
  ...
  case 2: // 32-bits
    if(is_unsigned) {
      ...
      if(!is_long) {
        ...
        if(quad) {
          quadlow = ((int32_t)quadlow1 > (int32_t)quadlow2) ? ((int32_t)quadlow1 - (int32_t)quadlow2)
                                                            : ((int32_t)quadlow2 - (int32_t)quadlow1);
          quadlow += quadacclow;

          quadhigh = ((int32_t)quadhigh1 > (int32_t)quadhigh2) ? ((int32_t)quadhigh1 - (int32_t)quadhigh2)
                                                               : ((int32_t)quadhigh2 - (int32_t)quadhigh1);
          quadhigh += quadacchigh;
        }
      } else {
        low     = ((int32_t)low1 > (int32_t)low2) ? ((int32_t)low1 - (int32_t)low2) : ((int32_t)low2 - (int32_t)low1);
  ...
  case 1: // 16-bits
    if(is_unsigned) {
      ...
      if(!is_long) {
        ...
        sixteen1 = low1 & 0xFFFF;
        sixteen2 = low2 & 0xFFFF;
        low      = ((int16_t)sixteen1 > (int16_t)sixteen2) ? ((int16_t)sixteen1 - (int16_t)sixteen2)
                                                      : ((int16_t)sixteen2 - (int16_t)sixteen1);

        sixteen1 = (low1 >> 16) & 0xFFFF;
        sixteen2 = (low2 >> 16) & 0xFFFF;
        high     = ((int16_t)sixteen1 > (int16_t)sixteen2) ? ((int16_t)sixteen1 - (int16_t)sixteen2)
                                                       : ((int16_t)sixteen2 - (int16_t)sixteen1);
        ...
        sixteen1 = high1 & 0xFFFF;
        sixteen2 = high2 & 0xFFFF;
        quadlow  = ((int16_t)sixteen1 > (int16_t)sixteen2) ? ((int16_t)sixteen1 - (int16_t)sixteen2)
                                                          : ((int16_t)sixteen2 - (int16_t)sixteen1);

        sixteen1 = (high1 >> 16) & 0xFFFF;
        sixteen2 = (high2 >> 16) & 0xFFFF;
        quadhigh = ((int16_t)sixteen1 > (int16_t)sixteen2) ? ((int16_t)sixteen1 - (int16_t)sixteen2)
                                                           : ((int16_t)sixteen2 - (int16_t)sixteen1);
  ...
  case 0: // 16-bits
    if(op) {
      if(round) {
        ...
        valU = (x & 0xffu) | ((x >> 8) & 0xff00u) | ((x >> 16) & 0xff0000u) | ((x >> 24) & 0xff000000u);
      }
    } else {
      if(round) {
        uint16_t s;
    ...
    if(op) {
      if(round) {
        ...
        valU2 = (x & 0xffu) | ((x >> 8) & 0xff00u) | ((x >> 16) & 0xff0000u) | ((x >> 24) & 0xff000000u);
      }
    } else {
      if(round) {
        uint16_t s;
