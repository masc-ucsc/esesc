...
bool GPUThreadManager::Timing_sbi_branchdiv(EmuSampler* gsampler, uint32_t* h_trace_qemu, void* env, uint32_t* qemuid) {
...
bool GPUThreadManager::Timing_sbi_swi_branchdiv(EmuSampler* gsampler, uint32_t* h_trace_qemu, void* env, uint32_t* qemuid) {
  bool atleast_oneSM_alive                 = false;
  uint64_t threads_in_current_warp_done    = 0;
  uint64_t threads_in_current_warp_barrier = 0;
  uint64_t timing_threads_complete         = 0;                  // USEME
