...
typedef enum Branch_divergence_type { serial = 0, post_dom = 1, sbi = 2, sbi_swi = 3, original = 4 } div_type;
...
// void GPUReader_getKernelParameters(uint32_t* DFL_REG32, uint32_t* DFL_REG64, uint32_t* DFL_REGFP, uint32_t* SM_REG32, uint32_t*
// SM_REG64, uint32_t* SM_REGFP, uint32_t* SM_ADDR , uint32_t* TRACESIZE);
void GPUReader_getKernelParameters(uint32_t *DFL_REG32, uint32_t *DFL_REG64, uint32_t *DFL_REGFP, uint32_t *DFL_REGFP64,
