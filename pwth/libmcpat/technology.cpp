...
void init_tech_params(double technology, bool is_tag)
{
  ...
  double aspect_ratio, wire_width, wire_thickness, wire_spacing, barrier_thickness, dishing_thickness,
         alpha_scatter, ild_thickness, miller_value = 1.5, horiz_dielectric_constant = 0.0, vert_dielectric_constant,
         fringe_cap, pmos_to_nmos_sizing_r;
  double curr_vdd_dram_cell = 0.0, curr_v_th_dram_access_transistor = 0.0,
         curr_I_on_dram_cell = 0.0, curr_c_dram_cell = 0.0;
  ...
  double curr_Wmemcella_dram = 0.0, curr_Wmemcellpmos_dram = 0.0, curr_Wmemcellnmos_dram = 0.0,
         curr_area_cell_dram = 0.0, curr_asp_ratio_cell_dram = 0.0, curr_Wmemcella_sram = 0.0,
         curr_Wmemcellpmos_sram = 0.0, curr_Wmemcellnmos_sram = 0.0, curr_area_cell_sram = 0.0,
         curr_asp_ratio_cell_sram = 0.0, curr_I_off_dram_cell_worst_case_length_temp = 0.0;
  double curr_Wmemcella_cam = 0.0, curr_Wmemcellpmos_cam = 0.0,
         curr_Wmemcellnmos_cam = 0.0, curr_area_cell_cam = 0.0,//Sheng: CAM data
