...
double wire_capacitance(double wire_width, double wire_thickness, double wire_spacing, double ild_thickness, double miller_value,
                        double horiz_dielectric_constant, double vert_dielectric_constant, double fringe_cap) {
...
void init_tech_params(double technology, bool is_tag) {
  ...
  double curr_alpha, curr_vpp = 0.0;
  double aspect_ratio, wire_width, wire_thickness, wire_spacing, barrier_thickness, dishing_thickness, alpha_scatter, ild_thickness,
      miller_value = 1.5, horiz_dielectric_constant = 0.0, vert_dielectric_constant, fringe_cap, pmos_to_nmos_sizing_r;
  double curr_vdd_dram_cell = 0.0, curr_v_th_dram_access_transistor = 0.0, curr_I_on_dram_cell = 0.0, curr_c_dram_cell = 0.0;
  ...
  double curr_Wmemcella_dram = 0.0, curr_Wmemcellpmos_dram = 0.0, curr_Wmemcellnmos_dram = 0.0, curr_area_cell_dram = 0.0,
         curr_asp_ratio_cell_dram = 0.0, curr_Wmemcella_sram = 0.0, curr_Wmemcellpmos_sram = 0.0, curr_Wmemcellnmos_sram = 0.0,
         curr_area_cell_sram = 0.0, curr_asp_ratio_cell_sram = 0.0, curr_I_off_dram_cell_worst_case_length_temp = 0.0;
  double curr_Wmemcella_cam = 0.0, curr_Wmemcellpmos_cam = 0.0, curr_Wmemcellnmos_cam = 0.0,
         curr_area_cell_cam   = 0.0, // Sheng: CAM data
      curr_asp_ratio_cell_cam = 0.0;
  double SENSE_AMP_D = 0.0, SENSE_AMP_P = 0.0; // J
  ...
  for(iter = 0; iter <= 1; ++iter) {
    ...
    if(tech == 90) {
      ...
      // Note that nmos_effective_resistance_multiplier, n_to_p_eff_curr_drv_ratio and gmp_to_gmn_multiplier values are calculated
      // offline
      ...
      curr_chip_layout_overhead  = 1.1;
      curr_macro_layout_overhead = 1.1;
    }
    ...
    if(tech == 65) { // 65nm technology-node. Corresponds to year 2007 in ITRS
      ...
      I_g_on_n[1][0]   = 1.09 - 10; // A/micron
      I_g_on_n[1][10]  = 1.09 - 10;
      I_g_on_n[1][20]  = 1.09 - 10;
      I_g_on_n[1][30]  = 1.09 - 10;
      I_g_on_n[1][40]  = 1.09 - 10;
      I_g_on_n[1][50]  = 1.09 - 10;
      I_g_on_n[1][60]  = 1.09 - 10;
      I_g_on_n[1][70]  = 1.09 - 10;
      I_g_on_n[1][80]  = 1.09 - 10;
      I_g_on_n[1][90]  = 1.09 - 10;
      I_g_on_n[1][100] = 1.09 - 10;
    ...
    if(tech == 32) {
      ...
      curr_asp_ratio_cell_cam = 2.92;
      // Empirical undifferetiated core/FU coefficient
      curr_logic_scaling_co_eff  = 0.7 * 0.7 * .07;
      curr_core_tx_density       = 1.25 / 0.7;
    ...
    if(tech == 22) {
      ...
      I_off_n[0][0] =
          1.52e-7 / 1.5 *
          1.2; // From 22nm, leakage current are directly from ITRS report rather than MASTAR, since MASTAR has serious bugs there.
    ...
    if(tech == 16) {
      // For 2016, MPU/ASIC stagger-contacted M1 half-pitch is 16 nm (so this is 16 nm
  ...
  double gmn_sense_amp_latch =
      (mobility_eff_periph_global / 2) * g_tp.peri_global.C_ox * (g_tp.w_sense_n / g_tp.peri_global.l_elec) * Vdsat_periph_global;
  ...
  for(iter = 0; iter <= 1; ++iter) {
    ...
    if(tech == 90) {
      ...
      alpha_scatter             = 1;
      wire_r_per_micron[0][0]   = wire_resistance(CU_RESISTIVITY, wire_width, wire_thickness, barrier_thickness, dishing_thickness,
      ...
      wire_c_per_micron[0][0]   = wire_capacitance(wire_width, wire_thickness, wire_spacing, ild_thickness, miller_value,
      ...
      wire_r_per_micron[0][1] =
          wire_resistance(CU_RESISTIVITY, wire_width, wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
      wire_c_per_micron[0][1] = wire_capacitance(wire_width, wire_thickness, wire_spacing, ild_thickness, miller_value,
                                                 horiz_dielectric_constant, vert_dielectric_constant, fringe_cap);
      ...
      wire_r_per_micron[0][2] =
          wire_resistance(CU_RESISTIVITY, wire_width, wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
      ild_thickness           = 0.96;
      wire_c_per_micron[0][2] = wire_capacitance(wire_width, wire_thickness, wire_spacing, ild_thickness, miller_value,
                                                 horiz_dielectric_constant, vert_dielectric_constant, fringe_cap);
      ...
      wire_c_per_micron[1][0]   = wire_capacitance(wire_width, wire_thickness, wire_spacing, ild_thickness, miller_value,
                                                 horiz_dielectric_constant, vert_dielectric_constant, fringe_cap);
      ...
      wire_r_per_micron[1][1] =
          wire_resistance(CU_RESISTIVITY, wire_width, wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
      wire_c_per_micron[1][1] = wire_capacitance(wire_width, wire_thickness, wire_spacing, ild_thickness, miller_value,
                                                 horiz_dielectric_constant, vert_dielectric_constant, fringe_cap);
      ...
      wire_r_per_micron[1][2] =
          wire_resistance(CU_RESISTIVITY, wire_width, wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
      ild_thickness           = 1.1;
      wire_c_per_micron[1][2] = wire_capacitance(wire_width, wire_thickness, wire_spacing, ild_thickness, miller_value,
                                                 horiz_dielectric_constant, vert_dielectric_constant, fringe_cap);
      ...
      wire_r_per_micron[0][0] =
          wire_resistance(BULK_CU_RESISTIVITY, wire_width, wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
      ild_thickness             = 0.405;
      miller_value              = 1.5;
