...
void InputParameter::serialize(Archive & ar, unsigned int version) {
  ar & cache_sz;
  ar & line_sz;
  ar & assoc;
  ar & nbanks;
  ...
  ar & leakage_power_wt_nuca,
  ar & cycle_time_wt_nuca;
  ar & area_wt_nuca;
  ar & delay_dev;
  ar & dynamic_power_dev;
  ar & leakage_power_dev,
  ar & cycle_time_dev;
  ar & area_dev;
  ar & delay_dev_nuca;
  ar & dynamic_power_dev_nuca;
  ar & leakage_power_dev_nuca,
  ar & cycle_time_dev_nuca;
  ar & area_dev_nuca;
  ar & ed;
  ar & nuca;
  ar & fast_access;
...
template<class Archive>
void results_mem_array::serialize(Archive & ar, unsigned int version) {
  ar & Ndwl;
  ar & Ndbl;
  ar & Nspd;
  ar & deg_bl_muxing;
...
template<class Archive>
void powerComponents::serialize(Archive & ar, unsigned int version) {
  ar & dynamic;
  ar & leakage;
  ar & gate_leakage;
  ar & short_circuit;
...
template<class Archive>
void powerDef::serialize(Archive & ar, unsigned int version) {
  ar & readOp;
  ar & writeOp;
  ar & searchOp;
}
...
template<class Archive>
void uca_org_t::serialize(Archive & ar, unsigned int version) {
  ar & tag_array2;
  ar & data_array2;
  ar & access_time;
  ar & cycle_time;
...
template<class Archive>
void mem_array::serialize(Archive & ar, unsigned int version) {
  ar & Ndwl;
  ar & Ndbl;
  ar & Nspd;
  ar & deg_bl_muxing;
