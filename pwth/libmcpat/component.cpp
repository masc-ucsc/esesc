...
double Component::compute_tr_width_after_folding(
    double input_width,
    double threshold_folding_width) { // This is actually the width of the cell not the width of a device.
...
double Component::height_sense_amplifier(double pitch_sense_amp) {
  ...
  double h_pmos_tr = compute_tr_width_after_folding(g_tp.w_sense_p, pitch_sense_amp) * 2 +
                     compute_tr_width_after_folding(g_tp.w_iso, pitch_sense_amp) + 2 * g_tp.MIN_GAP_BET_SAME_TYPE_DIFFS;
  ...
  double h_nmos_tr = compute_tr_width_after_folding(g_tp.w_sense_n, pitch_sense_amp) * 2 +
                     compute_tr_width_after_folding(g_tp.w_sense_en, pitch_sense_amp) + 2 * g_tp.MIN_GAP_BET_SAME_TYPE_DIFFS;
