...
{/*{{{*/
  ...
  //Instruction buffer
  int data							           = XML->sys.gpu.homoSM.homolane.instruction_length;//icache.caches.l_ip.line_sz; //multiple threads timing sharing the instruction buffer.
  ...
  interface_ip.cache_sz            = XML->sys.gpu.homoSM.homolane.number_hardware_threads*
    XML->sys.gpu.homoSM.homolane.instruction_buffer_size*
    interface_ip.line_sz>64?
...
{/*{{{*/
  ...
  interface_ip.cache_sz            = XML->sys.gpu.homoSM.homolane.store_buffer_size*interface_ip.line_sz*
    XML->sys.gpu.homoSM.homolane.number_hardware_threads;
