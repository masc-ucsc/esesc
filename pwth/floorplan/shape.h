 ...
 */
shape_t *shape_from_aspect(double area, double min, double max, int rotable, int n_orients);
...
tree_node_t *tree_from_NPE(flp_desc_t *flp_desc, tree_node_stack_t *stack, NPE_t *expr);
 ...
 */
int tree_to_flp(tree_node_t *root, flp_t *flp, int compact_dead, double compact_ratio);
#endif
