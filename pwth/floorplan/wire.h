 ...
 * can be calculated.
 */
#define WIRE_LCRIT_I (WIRE_LCRIT_G * sqrt((WIRE_R_G / WIRE_R_I) * (WIRE_C_G / WIRE_C_I)))
#define WIRE_SOPT_I (WIRE_SOPT_G * sqrt((WIRE_R_G / WIRE_R_I) / (WIRE_C_G / WIRE_C_I)))
 ...
 * care of the units
 */
#define WIRE_DELAY_G (WIRE_LCRIT_G * WIRE_R_G * WIRE_C_G * 1.0e-9 * (2.0 * WIRE_A + sqrt(2.0 * WIRE_A * WIRE_B)))
#define WIRE_DELAY_I (WIRE_LCRIT_I * WIRE_R_I * WIRE_C_I * 1.0e-9 * (2.0 * WIRE_A + sqrt(2.0 * WIRE_A * WIRE_B)))
