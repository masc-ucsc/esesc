...
public:
  ...
  static PMessage *createMsg(MessageType msgType, ProtocolBase *srcPB, ProtocolBase *dstPB, MemRequest *memReq);
  ...
  void setupMessage(ProtocolBase *src, ProtocolBase *dst, MessageType t);
