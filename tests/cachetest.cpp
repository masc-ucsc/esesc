...
GMemorySystem *gms0 = 0;
GMemorySystem *gms1 = 0;
void initialize(){
  ...
  if(!pluggedin){
    ...
    gms0 = new MemorySystem(0);
    gms0->buildMemorySystem();
    gms1 = new MemorySystem(1);
    gms1->buildMemorySystem();
#endif
    pluggedin=true;
  }
